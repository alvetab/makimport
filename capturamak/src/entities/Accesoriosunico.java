...
/**
 * The persistent class for the accesoriosunicos database table.
 * 
 */
@Entity
@Table(name="accesoriosunicos")
@NamedQuery(name="Accesoriosunico.findAll", query="SELECT a FROM Accesoriosunico a")
public class Accesoriosunico implements Serializable {
