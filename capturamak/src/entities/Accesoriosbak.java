...
/**
 * The persistent class for the accesoriosbak database table.
 * 
 */
@Entity
@NamedQuery(name="Accesoriosbak.findAll", query="SELECT a FROM Accesoriosbak a")
public class Accesoriosbak implements Serializable {
