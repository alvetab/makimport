...
public class Mapasdespieces {
	...
	private static ArrayList<String> nombremodelo, fotos,urlparamapas;
	String[][] tekensvalues;
	
	
	public Mapasdespieces(Document html_capturado) {  //captura las direcciones http para descargar las fotos y mapas del despiece (posteriormente ha de montar todos los maps para construmak)
	...
	public ArrayList<String> urlmapas(){
		return this.urlparamapas;		
	}
