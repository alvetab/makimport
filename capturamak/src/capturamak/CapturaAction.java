    ...
    private static ArrayList<String> listafinal;
	    ...
	    public void captura() throws InterruptedException{
		   ...
		   if (properties.getProperty("CNM").contains("false")){
			   ...
			   //ArrayList<String> listadourls = listasurls.capturaurls(properties.getProperty("NOVEDAD_MAKITA"));
			   } 
			   else {System.out.println("captura solo cambios en Novedades Makita");}
		   }
		   ...
		   else {System.out.println("captura solo cambios en Novedades Dolmar");}
	   }
		   ...
		   if (properties.getProperty("CAM").contains("false")){
			   ...
			   else {System.out.println("captura solo cambios en Artículos Makita");}
		   }
		   ...
		   if (properties.getProperty("CAD").contains("false")){
			   ...
			   else {System.out.println("captura solo cambios en Artículos Dolmar");}
		   }
		   ...
		   if (properties.getProperty("COP").contains("false")){
			   ...
			   else {System.out.println("captura solo Articulos sueltos nuevos");}
		   }
		   ...
		   if (properties.getProperty("CDM").contains("false")){
			   ...
			   else {System.out.println("captura solo cambios en despieces Makita");}
		   }
		   ...
		   if (properties.getProperty("CDD").contains("false")){
			   ...
			   else {System.out.println("captura solo cambios en despieces Dolmar");}
		   }
		   ...
		   if (properties.getProperty("CMM").contains("false")){
			   ...
			   else {System.out.println("captura solo cambios en mauales Makita");}
		   }
		   ...
		   if (properties.getProperty("CMD").contains("false")){
			   ...
			   else {System.out.println("captura solo cambios en maunuales Dolmar");}
		   }
	   }
	    ...
	    public void run(){
			...
			for (String urlscapturadas : listadourls){
				...
				//System.out.println(urls);
				try {
					emurls.crear(modelo.valueOf(valuemodelo),urlscapturadas,reftipo,true,true);
