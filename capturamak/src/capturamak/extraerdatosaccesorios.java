...
public class extraerdatosaccesorios { // capturar pestaña informacion general
	...
	public static String fotos2(String datosweb) {
		Document doc;
		// result = null;
	...
	public static String arreglo(String datosweb) {
		Document doc;
		// result = null;
		doc = Jsoup.parse(datosweb);
		Elements img = doc.getElementsByTag("img");
